  ...
  return (
    <div className="explore-landing">
      <main>
          ...
          <div className="explore-container explore-hero__layout">
            <div className="explore-hero__content">
              ...
              <div className="explore-actions">
                <Link className="explore-cta explore-cta--primary" to="/descubrir">
                  EXPLORAR AHORA <ArrowRight size={20} aria-hidden="true" />
                </Link>
            ...
            <div className="explore-carousel__viewport" aria-live="polite" aria-atomic="true">
              <article key={slide.id} className="explore-carousel__slide">
                <div className="explore-carousel__copy">
                  ...
                  <Link to="/descubrir" className="explore-carousel__link">
                    ABRIR BRUUK <ArrowRight size={18} aria-hidden="true" />
                  </Link>
                </div>
        ...
        <section id="como-funciona" className="explore-how" aria-labelledby="explore-how-title">
          <div className="explore-container">
            <span className="explore-kicker">/ Cómo funciona</span>
            <h2 id="explore-how-title">TRES PASOS. CERO RUTINA.</h2>
            <ol className="explore-how__grid">
              <li>
                <span className="explore-how__number">01</span>
                <h3>Elige tu ciudad</h3>
                <p>Elige una ciudad disponible y mira lo que está pasando cerca de ti.</p>
              </li>
              <li>
                <span className="explore-how__number">02</span>
                <h3>Descubre sin algoritmo</h3>
                <p>Desliza entre lugares y experiencias curadas por personas, no por tendencias.</p>
              </li>
              <li>
                <span className="explore-how__number">03</span>
                <h3>Sal y conecta</h3>
                <p>Guarda un plan, únete y conoce gente donde la vida sí está ocurriendo.</p>
              </li>
            </ol>
          </div>
        </section>
        ...
        <section className="explore-closing" aria-labelledby="explore-closing-title">
          <div className="explore-container explore-closing__content">
            ...
            <div className="explore-actions explore-actions--center">
              <Link className="explore-cta explore-cta--dark" to="/descubrir">
                ABRIR BRUUK <ArrowRight size={20} aria-hidden="true" />
              </Link>
              <button
