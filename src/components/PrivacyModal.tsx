        ...
        <div className="privacy-modal-inner">
          ...
          <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '1rem', lineHeight: '1.7', color: '#ffffff', textAlign: 'left' }}>
            ...
            <ul style={{ paddingLeft: '1.5rem', margin: '0.8rem 0' }}>
              ...
              <li><strong>Spots de la comunidad:</strong> Si recomiendas un lugar, recopilamos su nombre, ciudad, ubicación o enlace, tu explicación y tu correo para poder revisar o confirmar la aportación.</li>
            </ul>
            ...
            <ul style={{ paddingLeft: '1.5rem', margin: '0.8rem 0' }}>
              ...
              <li><strong>Curar recomendaciones:</strong> Revisar los spots compartidos por la comunidad y decidir si se integran a futuras guías de Bruuk.</li>
            </ul>
            ...
            <p>
              ...
              servicios de infraestructura con controles de acceso y seguridad. Las recomendaciones de spots se envían a un chat privado de Telegram del equipo de Bruuk; el token del bot permanece únicamente en el servidor.
            </p>
